...
REM ============================================================
REM PaddleOCR PDF -> Markdown GUI 26.8.13.04 EXE 打包器
...
set "EXE_NAME=PaddleOCR_PDF_to_MD_26.8.13.04.exe"
...
echo ============================================================
echo PaddleOCR PDF -^> Markdown GUI 26.8.13.04 EXE 打包器
...
"%PYTHON%" -m nuitka ^
  ...
  --onefile-tempdir-spec="{CACHE_DIR}/PaddleOCR/PDFToMarkdown/26.8.13.04" ^
  --mingw64 ^
  ...
  --file-version=26.8.13.4 ^
  --product-version=26.8.13.4 ^
  --output-dir="%WORKDIR%" ^
