...
REM ============================================================
REM PaddleOCR PDF -> Markdown GUI 26.7.27.02 EXE 打包器
...
set "EXE_NAME=PaddleOCR_PDF_to_MD_26.7.27.02.exe"
...
echo ============================================================
echo PaddleOCR PDF -^> Markdown GUI 26.7.27.02 EXE 打包器
...
"%PYTHON%" -m nuitka ^
  ...
  --onefile-tempdir-spec="{CACHE_DIR}/PaddleOCR/PDFToMarkdown/26.7.27.02" ^
  --mingw64 ^
  ...
  --file-version=26.7.27.2 ^
  --product-version=26.7.27.2 ^
  --output-dir="%WORKDIR%" ^
